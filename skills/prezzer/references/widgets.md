...
- **Tell the presenter.** Put the cue in the slide's `notes` (`"space starts the demo"`) and consider on-canvas hint text, because a spacebar that visibly does nothing reads as a crash.
